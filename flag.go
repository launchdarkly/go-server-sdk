...
func (f FeatureFlag) evaluateDetail(user lduser.User, store DataStore, sendReasonsInEvents bool) (EvaluationDetail, []FeatureRequestEvent) {
	if f.On {
...
func (f FeatureFlag) checkPrerequisites(user lduser.User, store DataStore, sendReasonsInEvents bool) (EvaluationReason, []FeatureRequestEvent) {
...
func (f FeatureFlag) evaluateInternal(user lduser.User, store DataStore) EvaluationDetail {
...
func (f FeatureFlag) getValueForVariationOrRollout(vr variationOrRollout, user lduser.User, reason EvaluationReason) EvaluationDetail {
...
func (r flagRule) matchesUser(store DataStore, user lduser.User) bool {
...
func (c clause) matchesUserNoSegments(user lduser.User) bool {
...
func (c clause) matchesUser(store DataStore, user lduser.User) bool {
...
func (r variationOrRollout) variationIndexForUser(user lduser.User, key, salt string) *int {
	if r.Variation != nil {
		return r.Variation
	}
	if r.Rollout == nil {
