...
// FlagBuilder is a builder for feature flag configurations to be used with [TestDataSynchronizer].
...
//
// This is the default for all new flags created with [TestDataSynchronizer.Flag]. The flag will have two
...
// [TestDataSynchronizer.Flag] with a new flag key, the flag will return false whenever targeting is
