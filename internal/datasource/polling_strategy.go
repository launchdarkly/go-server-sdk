...
// data source. It owns:
//
//   - the attempts counter n (RETRY §1.4);
...
// successes reset attempts and return the SDK to the normal regime (RETRY §1.8
...
// Formula: T = initialDelay * 2^(attempts-1), clamped to maxDelay.
