...
//
//     config := ld.Config{
//         DataStore: ldcomponents.PersistentDataStore(redis.DataStore()),
//     }
...
//             redis.DataStore().URL(myRedisURL),
//         ).CacheSeconds(30),
//     }
//
...
// options with redis.DataStore(). Note that some Redis client features can also be
