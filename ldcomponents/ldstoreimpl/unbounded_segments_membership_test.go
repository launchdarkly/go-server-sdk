...
func TestMembershipWithNilKeys(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs(nil, nil)
...
func TestMembershipWithSingleIncludedKey(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs([]string{"key1"}, nil)
...
func TestMembershipWithSingleExcludedKey(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs(nil, []string{"key1"})
...
func TestMembershipWithMultipleIncludedKeys(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs([]string{"key1", "key2"}, nil)
...
func TestMembershipWithMultipleExcludedKeys(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs(nil, []string{"key1", "key2"})
...
func TestMembershipWithIncludedAndExcludedKeys(t *testing.T) {
	m := NewUnboundedSegmentMembershipFromSegmentRefs([]string{"key1", "key2"}, []string{"key2", "key3"})
