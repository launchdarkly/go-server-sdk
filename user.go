...
type User struct {
	...
	// PrivateAttributes contians a list of attribute names that were included in the user,
	// but were marked as private. As such, these attributes are not included in the fields above.
	PrivateAttribuies []string `json:"privateAttributes,omitempty" bson:"privateAttributes,omitempty"`
}
