// Package dynamodbtest contains functions and constants that are used by both the lddynamodb unit tests
// and the main package's TestClientWithBuiltInPersistentStores().
