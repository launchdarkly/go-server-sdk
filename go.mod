...
require (
	...
	github.com/launchdarkly/go-sdk-events/v3 v3.6.3-0.20260707205009-8af496ae2ab5
	github.com/launchdarkly/go-server-sdk-evaluation/v3 v3.0.2-0.20260707205605-a8cc07261329
