...
func newUnknownFlagEvent(key string, user User, defaultVal ldvalue.Value, reason EvaluationReason,
	...
	defaultAsIntf := defaultVal.UnsafeArbitraryValue() //nolint:megacheck (using deprecated method)
	fre := FeatureRequestEvent{
		BaseEvent: BaseEvent{
			CreationDate: now(),
			User:         user,
...
func newSuccessfulEvalEvent(flag *FeatureFlag, user User, variation *int, value, defaultVal ldvalue.Value,
	...
	fre := FeatureRequestEvent{
		...
		Variation:            variation,
		Value:                value.UnsafeArbitraryValue(),      //nolint:megacheck (using deprecated method)
		Default:              defaultVal.UnsafeArbitraryValue(), //nolint:megacheck (using deprecated method)
		PrereqOf:             prereqOf,
