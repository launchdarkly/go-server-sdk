...
func newUnknownFlagEvent(key string, user lduser.User, defaultVal ldvalue.Value, reason EvaluationReason,
...
func newSuccessfulEvalEvent(flag *FeatureFlag, user lduser.User, variation *int, value, defaultVal ldvalue.Value,
